...
export default function Navbar() {
  ...
  return (
    <>
      {/* Announcement Bar */}
      <div className="bg-foreground text-background text-xs font-medium py-2 text-center tracking-wide">
        ✨ Premium Quality Guaranteed • Free Shipping above ₹1000 • 3-5 Days Delivery
      </div>
      <header 
