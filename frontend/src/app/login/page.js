  ...
  return (
    <div className="min-h-screen bg-background flex flex-col items-center justify-center pt-24 pb-12 px-4 sm:px-6 lg:px-8">
      ...
      >
        ...
        {/* Social Login */}
        <button className="w-full flex items-center justify-center gap-3 bg-white border border-gray-200 text-gray-700 hover:bg-gray-50 px-4 py-3.5 rounded-xl font-medium transition-colors mb-6 shadow-sm">
              ...
              >
                ...
                <div>
                  <div className="flex items-center justify-between mb-1">
                    ...
                    <a href="#" className="text-xs font-medium text-accent-blue hover:text-blue-700">Forgot?</a>
                  </div>
                  <div className="relative">
                    <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none text-gray-400">
