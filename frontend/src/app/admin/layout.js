...
export default function AdminLayout({ children }) {
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col md:flex-row font-sans safe-top safe-bottom">
        {/* Mobile Header */}
        <header className="md:hidden bg-white border-b border-gray-100 p-4 sticky top-0 z-40 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <h1 className="font-heading font-bold text-lg tracking-tighter text-black">
              MADRAS<span className="text-accent-yellow">.</span>WALL
            </h1>
          </div>
        ...
        {/* Main Content Area */}
        <main className="flex-1 md:ml-64 p-4 md:p-8 w-full max-w-full overflow-x-hidden min-h-[calc(100vh-64px)] md:min-h-screen">
